    ...
    public class ConsultarLojasUseCase : IConsultarLojasUseCase
    {
        ...
        public async Task<List<LojaViewModel>> Execute(string pesquisa, string inicio, string intervalo)
        {
            ...
            return lojas.Select(l => new LojaViewModel
            {
                ...
                LojTema = l.LojTema,
                LojCorFundo = l.LojCorFundo,
                LojBannerImg = l.LojBannerImg,
                LojBannerTitulo = l.LojBannerTitulo,
                LojBannerSubtitulo = l.LojBannerSubtitulo,
                LojFavicon = l.LojFavicon,
                LojHorario = l.LojHorario,
                LojSobre = l.LojSobre,
                LojLinkVenderCarro = l.LojLinkVenderCarro,
                LojMostrarMarcas = l.LojMostrarMarcas,
                LojMostrarMapa = l.LojMostrarMapa,
