namespace ConnectVeiculos.Core.Entities.Leads
{
    public class Lead
    {
        ...
        public string LeaOrigem { get; private set; } // WHATSAPP_CATALOGO, WHATSAPP_DETALHE, TEST_DRIVE, DIRETO, INDICACAO, FINANCIAMENTO
        ...
        // Campos especificos de financiamento
        public string LeaCpf { get; private set; }
        public decimal? LeaRenda { get; private set; }
        public decimal? LeaEntrada { get; private set; }
        public int? LeaParcelas { get; private set; }
        ...
        public Lead(int leaId, int? rVeiId, int? rLojId, string leaNomeCliente, string leaTelefone,
            ...
            string leaCpf = null, decimal? leaRenda = null, decimal? leaEntrada = null, int? leaParcelas = null)
        {
            LeaId = leaId;
            R_VeiId = rVeiId;
            R_LojId = rLojId;
            ...
            LeaCpf = leaCpf;
            LeaRenda = leaRenda;
            LeaEntrada = leaEntrada;
            LeaParcelas = leaParcelas;
        }
